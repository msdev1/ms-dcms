...
if (file_exists($theme))
	...
	echo "<link href='{$theme}' rel='stylesheet' type='text/css' /><meta name='viewport' content=' width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, ' >
<link rel='stylesheet' type='text/css' href='http://test.lumen/css/bootstrap.min.css'/><link rel='stylesheet' type='text/css' href='http://test.lumen/css/app.css'/>
<script  type='text/javascript' src='http://test.lumen/js/jquery.min.js'></script><script  type='text/javascript' src='http://test.lumen/js/bootstrap.min.js'></script><script  type='text/javascript' src='http://test.lumen/js/app.js'></script>", PHP_EOL;
else
	// only use the default stylesheet if an external one does not exist
	echo "<link href='?resource=css' rel='stylesheet' type='text/css' /><meta name='viewport' content=' width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, ' >
<link rel='stylesheet' type='text/css' href='http://test.lumen/css/bootstrap.min.css'/><link rel='stylesheet' type='text/css' href='http://test.lumen/css/app.css'/>
<script  type='text/javascript' src='http://test.lumen/js/jquery.min.js'></script><script  type='text/javascript' src='http://test.lumen/js/bootstrap.min.js'></script><script  type='text/javascript' src='http://test.lumen/js/app.js'></script>", PHP_EOL;
...
else //user is authorized - display the main application
{
	...
	echo "<div id='leftNav'>";
	echo "<h1><a href='".PAGE."'>";
	echo "<span id='logo'><img  style='max-height:45px' src='img/logo-color hd.png'></img></span><br> <span id='version'></span>";
	echo "</a></h1>";
	echo "<div id='headerlinks'>";
	echo "<span id='logo'>".PROJECT."<br>".VERSION."</span>";
